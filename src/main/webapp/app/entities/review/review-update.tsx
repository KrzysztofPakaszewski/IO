    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="culexApp.review.home.createOrEditLabel">Create or edit a Review</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : reviewEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="review-score" type="string" className="form-control" name="score" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvInput id="review-reviewer" type="select" className="form-control" name="reviewer.id">
                    <option value="" key="0" />
                    {users
